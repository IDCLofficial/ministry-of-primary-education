...
export default function SearchComponent() {
    ...
    const allItems: SearchItem[] = React.useMemo(() => [
        // Pages
        {
            ...
            action: () => router.push('/exam-portal/dashboard')
        },
        {
            id: 'students',
            ...
            action: () => router.push('/exam-portal/dashboard/schools')
        },
        {
            id: 'view-uploads',
            title: 'View Uploads',
            ...
            action: () => router.push('/exam-portal/dashboard/view-uploads')
        },
        // {
        //     id: 'audit-trail',
        //     title: 'Audit Trail',
        ...
        //     action: () => router.push('/exam-portal/dashboard/audit-trail')
        // },
        {
            id: 'certificates',
            title: 'Certificates',
            ...
            category: 'pages',
            icon: <IoDocumentTextOutline className="w-5 h-5" />,
            action: () => router.push('/exam-portal/dashboard/certificates')
        },
        // Actions
        {
            id: 'upload',
            ...
            action: () => router.push('/exam-portal/dashboard/upload')
        },
    ], [router]);
