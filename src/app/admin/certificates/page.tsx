      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-white shadow-sm border-b">
          <div className="px-6 py-4">
            ...
            <p className="text-gray-600 mt-1">Manage educational certificates and credentials</p>
          </div>
        </div>
        ...
        <div className="p-6">
          <div className="bg-white rounded-lg shadow-sm p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Issue, verify, and manage educational certificates and credentials.</p>
