...
function AdminSystemLoginContent() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* RIGHT SIDE */}
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-gradient-to-br from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8">
