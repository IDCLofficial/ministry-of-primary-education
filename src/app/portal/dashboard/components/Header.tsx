    ...
    return (
        <header className='sm:p-4 sticky sm:top-4 top-2 z-50 p-2 bg-white/50 backdrop-blur-lg flex justify-between items-center rounded-xl shadow-lg shadow-black/5 border border-black/10'>
            ...
            <div className='flex items-center gap-4'>
                {school && (
                    <div className='sm:flex hidden gap-2 items-center text-right'>
                        <div>
                            ...
                            {school.schoolCode && <p className='text-xs text-gray-500'>Code: {school.schoolCode}</p>}
                        </div>
                        <svg
                            height="25px"
                            width="25px"
                ...
                <button
                    onClick={logout}
                    className="inline-flex items-center cursor-pointer px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
                >
