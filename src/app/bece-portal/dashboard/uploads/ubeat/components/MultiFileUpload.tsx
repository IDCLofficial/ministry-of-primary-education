    ...
    <div className={`flex flex-col items-center justify-center h-full ${className}`}>
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Upload UBEAT Results</h2>
          <p className="text-gray-600">Upload CSV or XLSX files containing UBEAT examination results</p>
          <p className="text-sm text-gray-500 mt-2">For XLSX files, each sheet will be processed as a separate school</p>
        </div>
