...
import { useGetResultsQuery, useGetSchoolByIdQuery, useGetSchoolsQuery } from '../../../../store/api/authApi'
    ...
    if (isLoading) {
        return (
            <div className='p-6 bg-white/50 backdrop-blur-[2px] h-full overflow-y-auto border border-black/10 m-1 mb-0 space-y-6'>
                <button
                    onClick={() => router.push(`/bece-portal/dashboard/schools/${schoolId}`)}
            ...
            <div className='p-6 bg-white/50 backdrop-blur-[2px] h-full overflow-y-auto border border-black/10 m-1 mb-0 space-y-6'>
                <div className="flex items-center justify-center h-64">
                    <div className="text-center">
                        ...
                        <Link
                            href={`/bece-portal/dashboard/schools/${schoolId}`}
