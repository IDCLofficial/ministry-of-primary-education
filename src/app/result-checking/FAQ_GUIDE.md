...
1. **FAQ Component**
   - **Path:** `src/app/result-checking/components/FAQ.tsx`
...
2. **FAQ Page (Standalone)**
   - **Path:** `src/app/result-checking/faq/page.tsx`
   - **URL:** `/result-checking/faq`
...
3. **Integrated in Landing Page**
   - **Path:** `src/app/result-checking/page.tsx`
...
Edit `src/app/result-checking/components/FAQ.tsx`:
