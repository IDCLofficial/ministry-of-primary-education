...
const STORAGE_KEYS = {
    PAYMENT_URL: 'ubeat_payment_url',
    PAYMENT_REF: 'ubeat_payment_reference',
    FORM_DATA: 'ubeat_alt_form_data',
...
function PendingView({
    ...
    const handleCancelConfirmed = () => {
        storage.clearPaymentData()
        router.push('/result-checking/ubeat')
    }
        ...
        >
            <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6 text-left">
                    <h3 className="font-semibold text-gray-900 text-sm">Need help? <div onClick={() => updateSearchParam("contacting-support", "true")} className='text-green-600 inline-block cursor-pointer'>Contact Support</div></h3>
                </div>
                ...
                <div className="space-y-3">
                    <button
                        ref={actionRef}
                        onClick={() => router.push('/result-checking/ubeat/dashboard')}
                        className="w-full bg-green-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-green-700 transition-colors duration-200 active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 cursor-pointer"
                    >
                        Go to Dashboard
                    </button>
