...
export default function UBEATVerifyPage() {
    ...
    const loginUrl = useMemo(() => {
        if (!payload?.examNo) return '/result-checking/ubeat'
        return `/result-checking/ubeat?examNo=${encodeURIComponent(payload.examNo)}`
    }, [payload?.examNo])
        ...
        return (
            <div className="min-h-screen bg-gradient-to-b from-white to-emerald-50/30 flex items-center justify-center p-4">
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 max-w-md w-full text-center">
                    ...
                    <Link href="/result-checking/ubeat" className="text-green-600 font-medium hover:underline">
                        Go to UBEAT login
                    </Link>
                </div>
            </div>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white to-emerald-50/30 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 max-w-md w-full relative">
                ...
                <p className="text-sm text-gray-500 mb-6 text-center">UBEAT Certificate</p>
