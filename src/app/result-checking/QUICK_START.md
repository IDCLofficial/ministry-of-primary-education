...
### Standard Login
1. Go to: `http://localhost:3000/result-checking`
...
```
✏️ src/app/result-checking/page.tsx          # Added exams, abbr tags
✏️ src/app/result-checking/bece/page.tsx     # Added abbr tag
```
...
See: `/src/app/result-checking/ubeat/PAYMENT_INTEGRATION_GUIDE.md`
