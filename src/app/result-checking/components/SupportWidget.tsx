                        ...
                        >
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        {/* Nigeria dial code prefix */}
                                        <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-[13px] text-slate-500 font-medium pointer-events-none select-none">
                                            +234
                                        </span>
                                        <Input
                                            id="phone"
                                            ...
                                            maxLength={11}
                                            className={`text-[13.5px] h-10 pl-12 ${errors.phone ? "border-red-400 focus-visible:ring-red-200" : "focus-visible:ring-green-200 focus-visible:border-green-500"}`}
                                        />
                                    </div>
...
function Widget() {
    ...
    const [contactSupport, { isLoading }] = useCustomerSupportMutation();
    ...
    function validate() {
        ...
        } else if (!/^0?[789][01]\d{8}$/.test(form.phone)) {
    ...
    function reset() {
        setForm({ fullName: "", school: "", lga: "", examYear: "", examType: "", examNumber: "", email: "", phone: "", reason: "", reasonOther: "" });
        setErrors({});
        setSubmitted(false);
        setTicketRef("");
    }
