...
### BECE Dashboard
- **Path:** `/result-checking/dashboard`
- **Login:** `/result-checking/bece`
- **Color Scheme:** Green
...
### UBEAT Dashboard  
- **Path:** `/result-checking/ubeat/dashboard`
- **Login:** `/result-checking/ubeat`
- **Payment:** `/result-checking/ubeat/payment`
- **Color Scheme:** Purple
...
├── bece/
│   └── (login page) → redirects to /result-checking/dashboard
├── dashboard/
│   └── (BECE dashboard)
└── ubeat/
    ├── (login page) → redirects to /result-checking/ubeat/dashboard
    ├── payment/
...
1. Create exam-specific folder: `/result-checking/{exam-name}/`
2. Create login page: `/result-checking/{exam-name}/page.tsx`
3. Create dashboard: `/result-checking/{exam-name}/dashboard/page.tsx`
...
- The generic `/result-checking/dashboard` is specifically for BECE
- Future exam types should follow the same pattern: `/result-checking/{exam-type}/dashboard`
- Redux store is configured in the result-checking layout for RTK Query support
